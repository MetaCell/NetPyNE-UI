    ...
    return <div>
      ...
      >
        ...
        <MenuItem 
          ...
          leftIcon={<FontIcon color={'#543a73'} className='fa fa-plus' />} 
        >
          New
        </MenuItem>
        <MenuItem 
          ...
          leftIcon={<FontIcon color={'#543a73'}/>}
        ...
        <MenuItem 
          ...
          leftIcon={<FontIcon color={'#543a73'} className='fa fa-download' />} 
        >
          Save as...
        </MenuItem>
        <MenuItem 
          id="appBarImportHLS"
          onClick={() => this.handleMenuItemClick('ImportHLS')} leftIcon={<ImportIcon color={'#543a73'} />} 
        >
          Import...
        </MenuItem>
        <MenuItem 
          id="appBarExportHLS" 
          onClick={() => this.handleMenuItemClick('ExportHLS')} leftIcon={<ExportIcon color={'#543a73'} />} 
        >
          Export...
        </MenuItem>
        <MenuItem 
          id="appBarImportCellTemplate" 
          onClick={() => this.handleMenuItemClick('ImportCellTemplate')} leftIcon={<CellTemplateIcon color={'#543a73'} />} 
        >
