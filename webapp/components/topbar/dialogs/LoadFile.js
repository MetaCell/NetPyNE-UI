...
class LoadFile extends React.Component {
  ...
  render () {
    ...
    let tab
      = this.state.loadSimData || this.state.loadNet ? "simulate" : "define";
          ...
          <Box display="flex" alignItems="center">
            <Tooltip title="File explorer" placement="top">
              <FolderOpenIcon
                ...
                onClick={() =>
                  this.showExplorerDialog("jsonModelFolder", false)
                }
              />
            </Tooltip>
            <TextField
              ...
              onChange={event =>
                this.setState({ jsonModelFolder: event.target.value })
              }
              helperText={
                ...
                <ListItem style={{ width: "50%" }} key={index}>
                  <ListItemIcon>
                    <Checkbox
                      onChange={() =>
                        this.setState(
                          ({ [loadOption.state]: oldState, ...others }) => ({ [loadOption.state]: !oldState, })
                        )
                      }
          ...
          <Box display="flex" alignItems="center">
            ...
            <Box width="50%" pl={3.5}>
              <Checkbox
                ...
                onChange={() =>
                  this.setState({ compileMod: !this.state.compileMod })
                }
              />
            </Box>
          </Box>
