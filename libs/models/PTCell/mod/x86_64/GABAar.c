...
#define Exp1 Exp1_GABAar
 extern double Exp1( double );
 /* declare global and static user variables */
#define Alpha Alpha_GABAar
 double Alpha = 1;
#define Beta Beta_GABAar
 double Beta = 0.5;
#define Cdur Cdur_GABAar
 double Cdur = 1.08;
#define Rtau Rtau_GABAar
 double Rtau = 0;
#define Rinf Rinf_GABAar
 double Rinf = 0;
 ...
 "Cdur_GABAar", &Cdur_GABAar,
 "Alpha_GABAar", &Alpha_GABAar,
 "Beta_GABAar", &Beta_GABAar,
 "Rinf_GABAar", &Rinf_GABAar,
 "Rtau_GABAar", &Rtau_GABAar,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 GABAar /Users/matteocantarelli/Documents/Development/NEURON-UI/libs/models/PTCell/mod/x86_64/GABAar.mod\n");
