...
extern Memb_func* memb_func;
 ...
 "iassign_H", _hoc_iassign,
 "settables_H", _hoc_settables,
 0, 0
};
...
#define _gth 0
#define minf_H _thread1data[0]
#define minf _thread[_gth]._pval[0]
#define usetable usetable_H
 double usetable = 1;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 H /Users/matteocantarelli/Documents/Development/NEURON-UI/libs/models/PTCell/mod/x86_64/H.mod\n");
...
/*CVODE*/
 ...
 static double _mfac_settables, _tmin_settables;
  ...
  if (_maktable) { double _x, _dx; _maktable=0;
   _tmin_settables =  - 200.0 ;
   _tmax =  200.0 ;
   _dx = (_tmax - _tmin_settables)/401.; _mfac_settables = 1./_dx;
   for (_i=0, _x=_tmin_settables; _i < 402; _x += _dx, _i++) {
...
static int  _f_settables ( _threadargsprotocomma_ double _lv ) {
   minf = 1.0 / ( 1.0 + exp ( ( VhlfMaxm - _lv ) / slopem ) ) ;
    return 0; }
...
static void _initlists(){
 ...
 _slist1[0] = &(m) - _p;  _dlist1[0] = &(Dm) - _p;
   _t_minf = makevector(402*sizeof(double));
_first = 0;
}
