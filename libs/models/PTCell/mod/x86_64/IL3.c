...
extern Memb_func* memb_func;
 ...
 "setdata_ical3", _hoc_setdata,
 "efun_ical3", _hoc_efun,
 "evaluate_fct_ical3", _hoc_evaluate_fct,
 "ghk_ical3", _hoc_ghk,
 0, 0
};
#define efun efun_ical3
#define ghk ghk_ical3
...
#define _gth 0
#define eCa eCa_ical3
 double eCa = 120;
#define m_inf_ical3 _thread1data[0]
#define m_inf _thread[_gth]._pval[0]
#define rat rat_ical3
 double rat = 1;
#define sh2 sh2_ical3
 double sh2 = 0;
#define sh1 sh1_ical3
 double sh1 = 0;
#define tau_m_ical3 _thread1data[1]
#define tau_m _thread[_gth]._pval[1]
 ...
 "sh2_ical3", &sh2_ical3,
 "rat_ical3", &rat_ical3,
 "m_inf_ical3", &m_inf_ical3,
 "tau_m_ical3", &tau_m_ical3,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 ical3 /Users/matteocantarelli/Documents/Development/NEURON-UI/libs/models/PTCell/mod/x86_64/IL3.mod\n");
