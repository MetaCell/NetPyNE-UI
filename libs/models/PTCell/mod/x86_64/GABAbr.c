...
#define Exp1 Exp1_GABAbr
 extern double Exp1( double );
 /* declare global and static user variables */
#define Alpha Alpha_GABAbr
 double Alpha = 0.016;
#define Beta Beta_GABAbr
 double Beta = 0.0047;
#define Cdur Cdur_GABAbr
 double Cdur = 85;
#define Rtau Rtau_GABAbr
 double Rtau = 0;
#define Rinf Rinf_GABAbr
 double Rinf = 0;
 ...
 "Cdur_GABAbr", &Cdur_GABAbr,
 "Alpha_GABAbr", &Alpha_GABAbr,
 "Beta_GABAbr", &Beta_GABAbr,
 "Rinf_GABAbr", &Rinf_GABAbr,
 "Rtau_GABAbr", &Rtau_GABAbr,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 GABAbr /Users/matteocantarelli/Documents/Development/NEURON-UI/libs/models/PTCell/mod/x86_64/GABAbr.mod\n");
