...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 Izhi2007a /Users/matteocantarelli/Documents/Development/NEURON-UI/libs/models/PTCell/mod/x86_64/izhi2007a.mod\n");
...
{
 {
   ...
   Vpre = V ;
   V = V + delta * ( k * ( V - vr ) * ( V - vt ) - u - I + Iin ) / ( C * 100.0 ) ;
   if ( Vpre <= c  && V > vpeak ) {
     V = c + 1.0 ;
     }
   if ( celltype < 5.0 ) {
