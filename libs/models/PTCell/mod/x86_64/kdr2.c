...
extern Memb_func* memb_func;
 ...
 "setdata_kdr2", _hoc_setdata,
 "FRT_kdr2", _hoc_FRT,
 "alpha_kdr2", _hoc_alpha,
 "beta_kdr2", _hoc_beta,
 "faco_kdr2", _hoc_faco,
 "ghkca_kdr2", _hoc_ghkca,
 "iassign_kdr2", _hoc_iassign,
 "mh_kdr2", _hoc_mh,
 0, 0
};
#define FRT FRT_kdr2
#define alpha alpha_kdr2
#define beta beta_kdr2
#define faco faco_kdr2
#define ghkca ghkca_kdr2
...
#define cao cao_kdr2
 double cao = 0;
#define erev erev_kdr2
 double erev = -95;
#define hexp hexp_kdr2
 double hexp = 0;
#define hq10 hq10_kdr2
 double hq10 = 3;
#define htemp htemp_kdr2
 double htemp = 36;
#define hbasetau hbasetau_kdr2
 double hbasetau = 0.25;
#define hvhalf hvhalf_kdr2
 double hvhalf = -39;
#define hbaserate hbaserate_kdr2
 double hbaserate = 0.095;
#define hgamma hgamma_kdr2
 double hgamma = 0.3;
#define hvalence hvalence_kdr2
 double hvalence = -6;
#define ki ki_kdr2
 double ki = 0.001;
#define mininf mininf_kdr2
 double mininf = 0.0001;
#define mexp mexp_kdr2
 double mexp = 3;
#define mq10 mq10_kdr2
 double mq10 = 3;
#define mtemp mtemp_kdr2
 double mtemp = 36;
#define mbasetau mbasetau_kdr2
 double mbasetau = 0.3;
#define mvhalf mvhalf_kdr2
 double mvhalf = -18;
#define mbaserate mbaserate_kdr2
 double mbaserate = 0.13;
#define mgamma mgamma_kdr2
 double mgamma = 0.7;
#define mvalence mvalence_kdr2
 double mvalence = 2.8;
#define vmin vmin_kdr2
 double vmin = -100;
#define vmax vmax_kdr2
 double vmax = 100;
#define vrest vrest_kdr2
 double vrest = 0;
 ...
 "erev_kdr2", &erev_kdr2,
 "vrest_kdr2", &vrest_kdr2,
 "mvalence_kdr2", &mvalence_kdr2,
 "mgamma_kdr2", &mgamma_kdr2,
 "mbaserate_kdr2", &mbaserate_kdr2,
 "mvhalf_kdr2", &mvhalf_kdr2,
 "mbasetau_kdr2", &mbasetau_kdr2,
 "mtemp_kdr2", &mtemp_kdr2,
 "mq10_kdr2", &mq10_kdr2,
 "mexp_kdr2", &mexp_kdr2,
 "hvalence_kdr2", &hvalence_kdr2,
 "hgamma_kdr2", &hgamma_kdr2,
 "hbaserate_kdr2", &hbaserate_kdr2,
 "hvhalf_kdr2", &hvhalf_kdr2,
 "hbasetau_kdr2", &hbasetau_kdr2,
 "htemp_kdr2", &htemp_kdr2,
 "hq10_kdr2", &hq10_kdr2,
 "hexp_kdr2", &hexp_kdr2,
 "vmax_kdr2", &vmax_kdr2,
 "vmin_kdr2", &vmin_kdr2,
 "ki_kdr2", &ki_kdr2,
 "mininf_kdr2", &mininf_kdr2,
 "cao_kdr2", &cao_kdr2,
 "cai_kdr2", &cai_kdr2,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 3);
 	...
 	ivoc_help("help ?1 kdr2 /Users/matteocantarelli/Documents/Development/NEURON-UI/libs/models/PTCell/mod/x86_64/kdr2.mod\n");
